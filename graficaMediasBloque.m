...
parfor i=1:N
    i
    [tum_final1(i),NumCarT] = fun_auto_bloque(semilla(i),600,40);
    [tum_final2(i),NumCarT] = fun_auto_bloque(semilla(i),800,40);
    [tum_final3(i),NumCarT] = fun_auto_bloque(semilla(i),1000,40);
    [tum_final4(i),NumCarT] = fun_auto_bloque(semilla(i),1200,40);
    [tum_final5(i),NumCarT] = fun_auto_bloque(semilla(i),1400,40);
end
