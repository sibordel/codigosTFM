...
parfor i=1:N
    i
    [tum_final1(i),vector_CART] = fun_auto_bloque(semilla(i),600,40);
...
% Sacamos en qué momento de tiempo se encuentra el número máximo de células CAR-T
valor_max_cart=0;
posicion=0;
...
% x1 =[1:2160 2160 1:2160 2160];
% y1 =[vector_max 0 vector_min 0];
x1 =[0 1:2160 2160 0 1:2160 2160];
...
plot(1:2160,vector_max, 'r','LineWidth',2)
% Curva de valores mínimos
plot(1:2160,vector_min, 'g','LineWidth',2)
% Curva de valores medeios
plot(1:2160,vector_media, 'b:','LineWidth',2)
...
subtitle('CAR-T_0 = 40, Ntum_0 = 600')
